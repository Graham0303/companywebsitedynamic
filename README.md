...
<head>
    <title> AGS Industries Limited </title>
...
<body>
    ...
    <div class="footer">
        Copyright © 2021 AGS Industries Limited, Developed by GRAHAM STANES
    </div>
    </div>
</body>
...
.banner{
    ...
    text-align: center;
    font-size: xx-large;
    background-image : url("/static/img/chip.jpg");
